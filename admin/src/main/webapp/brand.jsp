         ...
         <div class="row g-3">
            ...
            <div class="col-auto">
               <div class="d-flex align-items-center gap-2 justify-content-lg-end">
                  ...
                  <button class="btn btn-primary px-4" onclick="window.location.href='add_brand.jsp'")"><i class="bi bi-plus-lg me-2"></i>Add Brand</button>
               </div>
            </div>
         </div>
         <!--end row-->
                              ...
                              <td>
                                 <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                       ...
                                       <li><a class="dropdown-item" href="brand-delete?id=<%=rs.getString("bid")%>">Delete</a></li>
                                    </ul>
                                 </div>
                              </td>
                           </tr>
