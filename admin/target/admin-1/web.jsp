<%-- 
    Document   : about_us
    Created on : 13-Apr-2023, 12:56:34 am
    Author     : chandnipatel
--%>
      ...
      <main class="page-content">
        ...
        <div class="row">
           <div class="col-12 col-lg-12">
              <div class="card">
                <form action="./UpdateWeb" method="post">
                    <%
                        Connection con = null;
                        Statement st = null;
                    ...
                    <div class="card-body">
                        <div class="mb-4">
                          <h5 class="mb-3">Website Name</h5>
                          <input type="text" class="form-control" placeholder="Enter Website Name" value="<%=rs.getString("webname")%>" name="name" id="name">
                       </div>
                       
                       <div class="mb-4">
                          <h5 class="mb-3">Website Short Description</h5>
                          <input type="text" class="form-control" placeholder="Enter Website Short Description" value="<%=rs.getString("sdes")%>" name="sdes" id="sdes">
                       </div>
                       
                       <div class="mb-4">
                          <h5 class="mb-3">Website Contact</h5>
                          <input type="text" class="form-control" placeholder="Enter Website Contact" value="<%=rs.getString("contact")%>" name="contact" id="contact">
                       </div>
                       
                       <div class="mb-4">
                          <h5 class="mb-3">Website Mail</h5>
                          <input type="text" class="form-control" placeholder="Enter Website mail" value="<%=rs.getString("email")%>" name="mail" id="mail">
                       </div>
                       
                       <div class="mb-4">
                          <h5 class="mb-3">Website Address</h5>
                          <input type="text" class="form-control" placeholder="Enter Website Address" value="<%=rs.getString("address")%>" name="address" id="address">
                       </div>
                       
                       <div class="mb-4">
                          <h5 class="mb-3">Website Embed Map Link</h5>
                          <input type="text" class="form-control" placeholder="Enter Website Address" value="<%=rs.getString("embedmap")%>" name="embedmap" id="embedmap">
                       </div>
